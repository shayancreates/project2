...
export function AnimatedTestimonialsDemo() {
  const testimonials = [
    ...
    {
      quote:
        "The AI-driven CV builder crafted a resume that finally got recruiters to notice me. Game-changer!",
      name: "Michael Rodriguez",
      designation: "Data Analyst at InnovateSphere",
    ...
    {
      quote:
        "The AI-powered job search tailored recommendations that matched my skill set perfectly. Highly recommend!",
      name: "Lisa Thompson",
      designation: "Product Designer at FutureNet",
